...
sudo sed -i 's/output_buffering = 4096/output_buffering = off/' /etc/php/8.1/apache2/php.ini
sudo sed -i 's/;opcache.interned_strings_buffer=8/opcache.interned_strings_buffer=32/' /etc/php/8.1/apache2/php.ini
sudo echo "apc.enable_cli=1" | sudo tee -a /etc/php/8.1/apache2/php.ini
